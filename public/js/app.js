...
var app = new Vue({
  ...
  }), _defineProperty(_methods, "toggleMenu", function toggleMenu() {
    // x menu mobile
  ...
  mounted: function mounted() {
    ...
    if (Cookies.get('totalPriceCookie') > 0) {
      ...
      Cookies.set('totalPriceCookie', this.totalPriceCookie, {
        expires: date
      });
    }
  ...
  watch: {
    ...
    cognome: function cognome(newCognome) {
      sessionStorage.cognome = newCognome;
      Cookies.set('cognome', this.cognome);
    },
    indirizzo: function indirizzo(newIndirizzo) {
