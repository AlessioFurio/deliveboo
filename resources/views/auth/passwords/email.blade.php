...
@section('content')
{{-- <div class="container"> --}}
    <div class="container-total-recovery-password">
        <div class="total-recovery-password">
            <div class="card-recovery-password">
                <div class="card-header-recovery-password">{{ __('Login Cliente') }}</div>
                ...
                <div class="card-body-recovery-password">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="form-recovery-password">
                            <label for="email" class="label-recovery-password">{{ __('E-Mail Address') }}</label>
